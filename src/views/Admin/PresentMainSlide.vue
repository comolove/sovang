...
export default class AdminPresentMainSlide extends Vue {
  ...
  private async onDelete(index: number) {
    try {
      if (confirm("삭제하시겠습니까?")) {
        await AxiosHelper.POST("/deletePresentMainSlide.php", {
          index: index
        });
