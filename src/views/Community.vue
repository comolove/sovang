    ...
    <section class="content-1">
      <HomeContent title="지역과 동행하는 푸릇농펠로십" data-aos="fade-up">
        ...
        <p>
          ...
          더합니다.
          <br />
          <br />일정 평수 미만의 경작지에서 종자 하나하나 마음 담는 농부님, 직접
          씨를 받아 자부심있게 경작하시는 생산자님, 토종종자만을 사용하시는
          푸릇한 양심 가득한 농부님 -
          <span v-if="!isMobile">소녀방앗간은</span> 모든 소농의 푸릇한 양심을
          존경하고 응원합니다.
        </p>
      </HomeContent>
    </section>
    <section class="content-2">
      ...
      <div v-if="isMobile" style="margin-top: 5.278vw;" data-aos="fade-up">
        <p>
          ...
          경작면적 0.1ha 이상 - 0.5ha 이하
          <br />
          <span class="blue">* 중소농업인 기준 :</span> 연소득 5천만원 이하 또는
          경작면적 0.5ha 이상 - 2ha 이하
        </p>
      </div>
      ...
      <div class="warning" v-if="!isMobile" data-aos="fade-up">
        <p>
          * 위 기준은 한국농촌경제연구원의 정책연구 보고 중 &lt;저소득 농가의
          ...
          <br />농업인 소득배가정책 자료에 근거한 기준입니다. 위 기준은 농업
