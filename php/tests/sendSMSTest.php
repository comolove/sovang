...
$sms['user_id'] = "yikolden"; // SMS 아이디
$sms['key'] = "eaopd6xar9wpq6fjuwwdoaovs03qlfq2";//인증키
/****************** 인증정보 끝 ********************/

/****************** 전송정보 설정시작 ****************/
$_POST['msg'] = '%고객명%님. 안녕하세요. API TEST SEND'; // 메세지 내용 : euc-kr로 치환이 가능한 문자열만 사용하실 수 있습니다. (이모지 사용불가능)
$_POST['receiver'] = '01034210329'; // 수신번호
$_POST['destination'] = '01034210329|담당자'; // 수신인 %고객명% 치환
$_POST['sender'] ="01034210329"; // 발신번호
// $_POST['rdate'] = '20200819'; // 예약일자 - 20161004 : 2016-10-04일기준
// $_POST['rtime'] = '2200'; // 예약시간 - 1930 : 오후 7시30분
